...
export { initComponent, readTestTemplet, writeAllTempleteToFiles, mkAllDir, readTempletE2e, writePluginListJson, creatDemoTemplete, creatMdTemplete, creatTemplete, creatPluginTemplete};
